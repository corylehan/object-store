...
func resetFileStorage(t *testing.T, tempDir string) *FileStorage {
	...
	objectStore, err := NewFileStorage(configFile)
	if err != nil {
		t.Fatal(err)
	}
...
func TestObjectStore(t *testing.T) {
	...
	testCases := []struct {
		name     string
		testFunc func(t *testing.T, os *FileStorage)
	}{
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			objectStore := resetFileStorage(t, tempDir)
			tc.testFunc(t, objectStore)
		})
	}
}

func testCreate(t *testing.T, os *FileStorage) {
    data := []byte("test data")
...
func testReadNonExistent(t *testing.T, os *FileStorage) {
...
func testUpdate(t *testing.T, os *FileStorage) {
...
func testDelete(t *testing.T, os *FileStorage) {
...
func testList(t *testing.T, os *FileStorage) {
...
func testCreateDuplicateName(t *testing.T, os *FileStorage) {
    data := []byte("data")
...
func testUpdateNonExistent(t *testing.T, os *FileStorage) {
    data := []byte("data")
...
func testDeleteNonExistent(t *testing.T, os *FileStorage) {
